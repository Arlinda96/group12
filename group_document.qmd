...
Each PC captures a certain amount of the total variance in the dataset. The first component captures 65% of the total variation which presents high importance for the data, separating the benign samples from the malignant samples.
